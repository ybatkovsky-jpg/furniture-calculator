...
- height_mm: высота (если не указана — стандарт: низ 716мм, верх 596мм, пенал 2500мм)
...
- Пенал может иметь 1 фасад (чаще всего) или 2 (если поделен). Смотри на чертёж, не предполагай!
- Игнорируй планки-заполнители
- Размеры только в мм, целыми числами
- Если точная высота не указана: низ=716, верх=596, пенал=2500
        ...
        if zone == "penal":
            ...
            for f in zone_facades:
                modules.append(RecognizedModule(
                    ...
                    width=f.width_mm,
                    depth=560,
                    height=f.height_mm if f.height_mm > 1500 else 2500,
                    quantity=1,

...
- width_mm: ширина — бери ТОЛЬКО с размерных линий на чертеже
- height_mm: высота — бери ТОЛЬКО с размерных линий на чертеже
- zone: "lower", "upper", "penal" — по расположению на чертеже
- is_corner: true только для углового фасада

ВАЖНО: все размеры УЖЕ написаны на чертеже. НЕ используй «стандартные» размеры. Читай цифры с размерных линий. Если цифра не читается — НЕ угадывай, укажи 0 и напиши в notes.

ПРАВИЛА:
- Каждая видимая дверца = ОДИН фасад
- Пенал: 1 или 2 фасада — смотри на чертёж, не предполагай
